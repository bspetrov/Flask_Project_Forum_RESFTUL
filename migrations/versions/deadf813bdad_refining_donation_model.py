"""Refining donation model

Revision ID: deadf813bdad
Revises: 282b7f9ee19b
Create Date: 2022-08-22 15:46:23.379774
...
revision = 'deadf813bdad'
down_revision = '282b7f9ee19b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('iban', sa.String(length=400), nullable=False),
